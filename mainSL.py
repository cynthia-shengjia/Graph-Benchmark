...
from tools.procedure import train_batch_multi_neg as train_batch_multi_neg
...
LOSSES = {
    "SL": optimizer.optim_SL.SLOptimizer
}
...
for epoch in range(world.config["epochs"]):
    ...
    loss = train_batch_multi_neg(model, loss_func, train_pos, x, interaction_tensor, world.config["batch_size"])
